...
export default async function MapPage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 3.5rem)' }}>
      {/* Stats bar */}
      <div className="bg-[#1e293b] text-white/70 px-4 py-2 flex items-center gap-6 text-xs shrink-0">
      ...
      <div className="flex-1 relative">
        ...
        <div className="absolute bottom-4 right-4 z-10 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow text-xs space-y-1.5">
          <div className="font-semibold text-stone-700 mb-2">Legend</div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-amber-500 border border-white shadow-sm" />
            <span className="text-stone-600">Journal post</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-[#2d5016]" />
            <span className="text-stone-600">Alaska stop</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-full bg-[#0ea5e9]" />
            <span className="text-stone-600">Hawaiʻi stop</span>
          </div>
        </div>
      </div>
    </div>
