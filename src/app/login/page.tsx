...
export default async function LoginPage({ searchParams }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center px-4">
      {/* Background texture */}
      <div className="absolute inset-0 bg-[url('/globe.svg')] opacity-[0.03] bg-center bg-no-repeat bg-[length:600px]" />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl font-bold text-white tracking-wide">AK · HI 2026</h1>
          <p className="text-white/40 text-sm mt-1">Alaska &amp; Hawaiʻi Adventure</p>
        </div>
